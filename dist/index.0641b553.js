...
var makeGalleryItemMarkup = function makeGalleryItemMarkup(image) {
    var description = image.description, original = image.original, preview = image.preview;
...
function imageEnlarge(evt) {
    ...
    if (imgClick.nodeName !== "IMG") return;
...
function closeModalByClick(e) {
    if (e.target === e.currentTarget) imageClose();
}
function closeModalByEsc(e) {
    if (e.key === "Escape") imageClose();
}

},{}]},["7Aums","bNKaB"], "bNKaB", "parcelRequired535")
